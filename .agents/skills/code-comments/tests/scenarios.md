# Code comments application scenarios
...
Return the comment verbatim as it should appear in the source,
...
- Preserve the success result, expiration calculation,
  joint visibility boundary, and specified insufficient-capacity behavior.
...
the fake matches the visible interface contract,
