...
name: cli-design
description: >
  Use when designing or changing a command-line interface, including commands,
  flags, output streams, structured output, exit status, or the boundary
  between command adapters and application behavior. Do not use merely to
  invoke an existing command.
---
